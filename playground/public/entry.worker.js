  ...
  async function startRedirectNavigation(state2, redirect7, _temp) {
    ...
    if (isBrowser) {
      ...
      if (redirect7.reloadDocument) {
        ...
        const url = init.history.createURL(redirect7.location);
...
var Action, PopStateEventType, ResultType, immutableRouteKeys, paramRe, dynamicSegmentValue, indexRouteValue, emptySegmentValue, staticSegmentValue, splatPenalty, isSplat, joinPaths, normalizePathname, normalizeSearch, normalizeHash, json3, AbortedDeferredError, DeferredData, defer, redirect2, redirectDocument, ErrorResponseImpl, validMutationMethodsArr, validMutationMethods, validRequestMethodsArr, validRequestMethods, redirectStatusCodes, redirectPreserveMethodStatusCodes, IDLE_NAVIGATION, IDLE_FETCHER, IDLE_BLOCKER, ABSOLUTE_URL_REGEX, defaultMapRouteProperties, UNSAFE_DEFERRED_SYMBOL;
...
// routes-module:routes/tasks.tsx?worker
var require_tasks = __commonJS({
  "routes-module:routes/tasks.tsx?worker"(exports, module) {
    module.exports = {};
  }
});
...
// routes-module:routes/tasks-two.tsx?worker
var tasks_two_exports = {};
__export(tasks_two_exports, {
  workerLoader: () => workerLoader5
});

// app/routes/tasks-two.tsx
var import_node5 = __toESM(require_node());
var import_react12 = __toESM(require_react());
var import_jsx_runtime8 = __toESM(require_jsx_runtime());
var workerLoader5 = () => {
  console.log("workerLoader in tasks-two route");
  return json({ message: "Hello from the worker!" });
};

// entry-module:@remix-pwa/build/magic
var route9 = __toESM(require_index());

// routes-module:routes/indigo.tsx?worker
var indigo_exports = {};
__export(indigo_exports, {
  workerLoader: () => workerLoader6
});

// app/routes/indigo.tsx
...
// entry-module:@remix-pwa/build/magic
var route11 = __toESM(require_tasks());

// routes-module:routes/_app.tsx?worker
var app_exports = {};
__export(app_exports, {
  workerLoader: () => workerLoader7
});

// app/routes/_app.tsx
var import_node6 = __toESM(require_node());
var import_react14 = __toESM(require_react());
var import_jsx_runtime10 = __toESM(require_jsx_runtime());
async function workerLoader7({ context }) {
  const { fetchFromServer } = context;
...
async function handleLoader({ event, loadContext, loader, routeId, routePath }) {
  ...
  console.log("handleLoader", result, "\nI sense a disturbance in the force...");
  if (result === void 0) {
